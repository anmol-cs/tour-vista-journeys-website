...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Find your next
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 animate-float">
              adventure
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-lg px-8 py-4 rounded-full hover-lift">
              Start Exploring
            </Button>
            <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm text-lg px-8 py-4 rounded-full">
              Plan Custom Trip
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover-lift group overflow-hidden">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Day Adventure */}
            <Card className="overflow-hidden hover-lift group border-0 shadow-xl">
              <div 
                className="h-80 bg-cover bg-center relative group-hover-scale transition-transform duration-500"
                style={{
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-3xl font-bold mb-2">Day Adventure</h3>
            ...
            <Card className="overflow-hidden hover-lift group border-0 shadow-xl">
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-3xl font-bold mb-2">Overnight Escape</h3>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <span className="text-3xl font-bold text-accent">$249</span>
                    <span className="text-gray-500 ml-2">per person</span>
                  </div>
                  <Button className="rounded-full bg-gradient-to-r from-accent to-primary">
                    Discover More
                  </Button>
                </div>
              </CardContent>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-primary via-accent to-orange-500 text-white overflow-hidden relative">
        <div className="absolute inset-0 bg-black/10"></div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in">Ready for your next story?</h2>
          <p className="text-xl mb-8 text-white/90">
            Join thousands of travelers who've discovered their favorite places with us
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-primary hover:bg-gray-50 rounded-full px-8 py-4 text-lg font-semibold">
              Start Planning
            </Button>
            <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm rounded-full px-8 py-4 text-lg">
              Chat with Expert
            </Button>
          </div>
        </div>
